...
<script src="<?php echo base_url('css_maruti/'); ?>assets/ajax.js"></script>
      ...
      <div class="modal fade" id="generate" role="dialog">
        <div class="modal-dialog">
          ...
          <!-- Modal content-->
          <form action="<?= base_url() ?>match/generate_terapis2" method="post">
  ...
  <form action="<?= base_url('Match/app_priode'); ?>" method="get">
         <div class="modal fade" id="modal-app">
          <div class="modal-dialog">
           <div class="modal-content">
            <div class="modal-header" style="background:#FFA07A;">
             <h4 class="modal-title">Appointment / Periode</h4>
             <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
...
<div class="modal fade" id="hapus_terapis" role="dialog">
        <div class="modal-dialog">
          ...
          <!-- Modal content-->
          <form action="<?= base_url() ?>match/hapus_terapis" method="post">
            <div class="modal-content">
              <div class="modal-header" style="background: #FFA07A;">
  ...
  <div class="modal-dialog modal-lg">
    ...
    <!-- <form method="post"> -->
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button id="cobai" method="submit" class="btn btn-info">Simpan</button>
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        </div>
      </div>
    <!-- </form> -->
...
function noResultsButtonClicked() {
  ...
  $('.pilih-metode option[value=manual]').attr('selected','selected');
      ...
      $('#addappointment').click(function(){
        ...
        html_code += "<td  class='' width='20%'><input type='time' class='form-control jam_mulai' name='jam_mulai' required='' value='"+jam_mulai+"'></td></td>";
      ...
      $('#cobai').click(function(){
        ...
        success:function(data){
          ...
          setTimeout("window.location.href='<?= base_url(); ?>match/app'", 700);          
          }         
        }
        });
        }
