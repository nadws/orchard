	...
	$(document).ready(function(){
		...
		function bayar_default(){
		  ...
		  var voucher = parseInt($("#nominal_voucher").val());
            ...
            var bayar = mandiri_kredit + mandiri_debit + cash + bca_kredit + bca_debit + dp + diskon + voucher;
			if(total <= bayar){
		...
		$('.pembayaran').keyup(function(){
            ...
            var bayar = mandiri_kredit + mandiri_debit + cash + bca_kredit + bca_debit + dp + diskon + nominal_voucher;
			if(total <= bayar){
				$('#btn_bayar').removeAttr('disabled');
			}else{
				$('#btn_bayar').attr('disabled','true');
