...
<!-- <div class="content-wrapper"> -->
	<div class="content-header">
		<div class="container">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">Record Denda</h1>
				</div>
				<div class="col-sm-6">
		...
		<div class="row">
			<div class="card-header">
				<div class="col-12">
					...
					<table id="example2" class="table" width="100%">
						...
						<thead style="background-color: white;">
							<form action="<?= base_url("Match/input_denda") ?>" method="POST">
								<tr>
									...
									<td> <input style="border:none; border-bottom: solid; width: 140px;" list="data_mahasiswa" onchange="return autofill_anak();" class="form-control" type="input" name="nm_denda" id="nm_kry" placeholder="Nama" required></td>
									
									<td><input style="border:none; border-bottom: solid;" class="form-control" type="text" name="alasan" placeholder="Alasan ?" required></td>
									<td><input style="border:none; border-bottom: solid;" class="form-control" type="number" name="nominal" required></td>
									<td>
				...
				<!-- ======================================================== conten ======================================================= -->
				<form action="<?= base_url('Match/denda2'); ?>" method="post">
				...
				<form action="<?= base_url('Match/summary_denda'); ?>" method="post">
				...
				<form action="<?= base_url('Match/drop_denda_skala'); ?>" method="post">
