	...
	<div class="container">
		<div class="row mb-2">
			...
			<div class="col-sm-6">
				...
				<?php endif ?>
				<a href="<?= base_url() ?>match/create_opname" class="btn btn-success float-right ml-2"><i class="fas fa-plus"></i> Stok Opname</a>
...
<form action="<?= base_url('Match/opname'); ?>" method="post">
...
<script>
	$(document).ready(function() {
		$(".clickable-row").click(function() {
			...
			window.location.href = '<?= base_url(); ?>match/detail_opname?kode_opname=' + no_opname;
